(()=>{var e={};e.id=918,e.ids=[918],e.modules={2849:e=>{function t(e){var t=Error("Cannot find module '"+e+"'");throw t.code="MODULE_NOT_FOUND",t}t.keys=()=>[],t.resolve=t,t.id=2849,e.exports=t},399:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8893:e=>{"use strict";e.exports=require("buffer")},4770:e=>{"use strict";e.exports=require("crypto")},7702:e=>{"use strict";e.exports=require("events")},8216:e=>{"use strict";e.exports=require("net")},5816:e=>{"use strict";e.exports=require("process")},6162:e=>{"use strict";e.exports=require("stream")},4026:e=>{"use strict";e.exports=require("string_decoder")},5346:e=>{"use strict";e.exports=require("timers")},2452:e=>{"use strict";e.exports=require("tls")},7360:e=>{"use strict";e.exports=require("url")},1764:e=>{"use strict";e.exports=require("util")},1568:e=>{"use strict";e.exports=require("zlib")},8306:(e,t,r)=>{"use strict";r.r(t),r.d(t,{originalPathname:()=>g,patchFetch:()=>y,requestAsyncStorage:()=>c,routeModule:()=>o,serverHooks:()=>p,staticGenerationAsyncStorage:()=>m});var i={};r.r(i),r.d(i,{GET:()=>_});var n=r(9303),a=r(8716),u=r(670),d=r(7070),l=r(2198),s=r(1402);async function _(e){try{let t=new URL(e.url).searchParams.get("drug_name");if(!t||!t.trim())return(0,s.Bp)("missing query parameter drug_name",["drug_name"]);let r=await (0,l.Bf)(t);if(!r)return(0,s.v6)("drug "+t+" not found");return d.NextResponse.json(r)}catch(t){let e=t instanceof Error?t.message:"Internal server error";return(0,s.I3)(e)}}let o=new n.AppRouteRouteModule({definition:{kind:a.x.APP_ROUTE,page:"/api/rdc/detail/route",pathname:"/api/rdc/detail",filename:"route",bundlePath:"app/api/rdc/detail/route"},resolvedPagePath:"E:\\project\\drug\\rdc-api\\app\\api\\rdc\\detail\\route.ts",nextConfigOutput:"",userland:i}),{requestAsyncStorage:c,staticGenerationAsyncStorage:m,serverHooks:p}=o,g="/api/rdc/detail/route";function y(){return(0,u.patchFetch)({serverHooks:p,staticGenerationAsyncStorage:m})}},1402:(e,t,r)=>{"use strict";r.d(t,{Bp:()=>a,I3:()=>d,v6:()=>u});var i=r(7070);function n({code:e,message:t,status:r,details:n=[]}){return i.NextResponse.json({error:{code:e,message:t,details:n}},{status:r})}function a(e,t=[]){return n({code:"VALIDATION_ERROR",message:e,status:422,details:t})}function u(e){return n({code:"NOT_FOUND",message:e,status:404})}function d(e){return n({code:"SERVER_ERROR",message:e,status:500})}},2198:(e,t,r)=>{"use strict";r.d(t,{Bf:()=>m,I3:()=>p,fV:()=>c,b_:()=>o,I9:()=>s,cN:()=>_});var i=r(3785);let n=null;function a(){return n||(n=function(){let e={host:process.env.DB_HOST??"127.0.0.1",port:process.env.DB_PORT?Number(process.env.DB_PORT):3306,user:process.env.DB_USER??"root",password:process.env.DB_PASS??"",database:process.env.DB_NAME??"rdcdb",waitForConnections:!0,connectionLimit:10,namedPlaceholders:!0};return i.createPool(e)}()),n}let u=["compound","ligand","linker","chelator","radionuclide"];function d(e){if(null==e)return null;let t=Number(e);return Number.isNaN(t)?null:t}function l(e){if(null==e)return null;if(e instanceof Date)return e.toISOString();let t=new Date(String(e));return Number.isNaN(t.getTime())?null:t.toISOString()}async function s(){let e=a(),[t]=await e.query("SELECT DISTINCT status FROM rdc_drug WHERE status IS NOT NULL AND status <> '' ORDER BY status");return t.map(e=>e.status).filter(e=>"string"==typeof e&&e.trim().length>0).map(e=>({value:e,label:e}))}async function _({q:e,limit:t=20}){let r=a(),i=`%${e.trim()}%`,[n]=await r.query(`SELECT drug_id, drug_name, status FROM rdc_drug
