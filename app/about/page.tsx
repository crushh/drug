...
export default function AboutPage() {
  const [openRdcdb, setOpenRdcdb] = useState(true);
  const [openRdcs, setOpenRdcs] = useState(true);
    ...
    <main style={{ padding: 24 }}>
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        >
          ...
          >
            <span>What is RDCdb?</span>
            <span style={{ fontSize: 16 }}>{openRdcdb ? "▾" : "▸"}</span>
          </div>
          {openRdcdb && (
        ...
        >
          ...
          >
            <span>What is the Radionuclide Drug Conjugates (RDCs)?</span>
            <span style={{ fontSize: 16 }}>{openRdcs ? "▾" : "▸"}</span>
          </div>
          {openRdcs && (
            <div style={{ padding: 16, background: "#fff" }}>
              <p style={{ lineHeight: 1.8, color: "#374151", marginBottom: 12 }}>
              ...
              <section style={{ marginBottom: 32 }}>
                <h3 style={{ fontSize: 18, fontWeight: 700, marginBottom: 12, color: PRIMARY_COLOR }}>
                  Ligand
                </h3>
                <p style={{ lineHeight: 1.8, color: "#374151", marginBottom: 12 }}>
